...
/* Disable //assertions? */
#ifndef DISABLE_//assert
 #define DISABLE_//assert 0
#endif

#if defined(DISABLE_//assert) && (DISABLE_//assert == 1)
 #define //assert(...)
#else
 #include <//assert.h>
#endif
...
void gf2field_inv(gf2elem_t z, const gf2elem_t x)
{
  gf2elem_t u, v, g, h;
  int i;
...
void gf2point_copy(gf2elem_t x1, gf2elem_t y1, const gf2elem_t x2, const gf2elem_t y2)
{
  bitvec_copy(x1, x2);
  bitvec_copy(y1, y2);
}

void gf2point_set_zero(gf2elem_t x, gf2elem_t y)
{
  bitvec_set_zero(x);
  bitvec_set_zero(y);
}

int gf2point_is_zero(const gf2elem_t x, const gf2elem_t y)
{
...
void gf2point_double(gf2elem_t x, gf2elem_t y)
{
...
void gf2point_add(gf2elem_t x1, gf2elem_t y1, const gf2elem_t x2, const gf2elem_t y2)
{
...
void gf2point_mul(gf2elem_t x, gf2elem_t y, const scalar_t exp)
{
  gf2elem_t tmpx, tmpy;
  int i;
