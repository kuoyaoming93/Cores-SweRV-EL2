...
/* Para RS(255,239) */
unsigned char msg[] = "Hola como estas que tal tu dia hoy es mi cumple y cual es el tuyo mi mama me va a preparar una torta y cual es tu regalo osea que regalo te van a hacer que te gustaria tener en realidad no me gusta festejar pero bueno asi es la vida que qu";
